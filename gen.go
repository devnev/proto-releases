...
//go:generate -command genrel protoc -I. fixtures/core.proto fixtures/imported.proto releases.proto
...
//go:generate protoc -I. --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative fixtures/core.proto fixtures/imported.proto
...
//go:generate -command genrelgo protoc fixtures/core.proto fixtures/imported.proto --go_opt=paths=source_relative --go-grpc_opt=paths=source_relative --go-baseconvert_opt=base=github.com/devnev/proto-releases/fixtures,paths=source_relative
