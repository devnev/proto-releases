...
func (c *testServiceClient) EmptyMethodReleased(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/com.github.devnev.proto_releases.fixtures.releases.stable3.fixtures.TestService/EmptyMethodReleased", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) MethodReleased(ctx context.Context, in *MessageNotAnnotated, opts ...grpc.CallOption) (*MessageNotAnnotated, error) {
	...
	err := c.cc.Invoke(ctx, "/com.github.devnev.proto_releases.fixtures.releases.stable3.fixtures.TestService/MethodReleased", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestService_EmptyMethodReleased_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.github.devnev.proto_releases.fixtures.releases.stable3.fixtures.TestService/EmptyMethodReleased",
	}
...
func _TestService_MethodReleased_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.github.devnev.proto_releases.fixtures.releases.stable3.fixtures.TestService/MethodReleased",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
